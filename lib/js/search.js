	...
	$(document).ready(function(){
		...
		$.ajax({
		  ...
		  var finderror = patt.test(responce);
            if(finderror == true)
			{
				alert("We were not able to sync your posts. Shoot us an email at search@methi.io with your magic key and wordpress version, we'll look into it right away!");
